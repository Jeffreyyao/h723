...
const I2CConfig i2c_cfg = {
  .timingr = STM32_TIMINGR_PRESC(2) |
      STM32_TIMINGR_SCLDEL(9U) | STM32_TIMINGR_SDADEL(0U) |
      STM32_TIMINGR_SCLH(112U)  | STM32_TIMINGR_SCLL(162U),
  .cr1 = 0,
  .cr2 = 0
};
...
int MLX90640_I2CRead(uint8_t slaveAddr, uint16_t startAddress, uint16_t nMemAddressRead, uint16_t *data)
{
  ...
  msg_t ack = i2cMasterTransmitTimeout(&I2CD4, slaveAddr, tx_buf, 2, p, nMemAddressRead*2, TIME_MS2I(50));
...
int MLX90640_I2CWrite(uint8_t slaveAddr, uint16_t writeAddress, uint16_t data)
{
  ...
  msg_t ack = i2cMasterTransmitTimeout(&I2CD4, slaveAddr, cmd, 2, NULL, 0, TIME_MS2I(50));
