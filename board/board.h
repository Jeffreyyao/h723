...
/*
 * Setup for STMicroelectronics STM32 Nucleo144-H723ZG board.
 */

/*
 * Board identifier.
 */
#define BOARD_ST_NUCLEO144_H723ZG
#define BOARD_NAME                  "Fanke FK723M1_ZGT6"
 ...
 */
#define LINE_WS2812_DATA            PAL_LINE(GPIOA, 0U)
...
#define LINE_GPIOA_PIN9             PAL_LINE(GPIOA, 9U)
...
#define LINE_LED                    PAL_LINE(GPIOG, 7U)
 ...
 */
#define VAL_GPIOA_MODER             (PIN_MODE_ALTERNATE(GPIOA_WS2812_DATA) |           \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_WS2812_DATA) |       \
...
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_WS2812_DATA) |       \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_WS2812_DATA) |         \
...
#define VAL_GPIOA_ODR               (PIN_ODR_LOW(GPIOA_WS2812_DATA) |             \
...
#define VAL_GPIOA_AFRL              (PIN_AFIO_AF(GPIOA_WS2812_DATA, 2U) |          \
